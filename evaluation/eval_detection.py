...
class ANETdetection(object):
    ...
    def _import_ground_truth(self, ground_truth_filename):
        ...
        for videoid, v in data['database'].items():
            # print(videoid)
            if os.path.exists(os.path.join("/home/phd/Desktop/sauradip_research/TAL/gtad/output/results2", "v_"+videoid + ".csv")):
                # print(v)
