...
class MultiHeadAttention(nn.Module):
    ...
    def __init__(self, n_head, d_model, d_k, d_v, dropout=0.1):
        ...
        # self.w_ks.requires_grad = True
        self.w_vs = nn.Linear(d_model, n_head * d_v, bias=False).cuda()
        # self.w_vs.requires_grad = True
    ...
    def forward(self, q, k, v):
        ...
        # print("attn", attn.requires_grad)
        # print("log_attn", log_attn.requires_grad)
        ...
        #     output = self.dropout(self.fc(output))
        #     output = self.layer_norm(output + residual)
        # print("layer_norm out", output.requires_grad)
        return output
